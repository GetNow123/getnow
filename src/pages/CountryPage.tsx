...
const CountryPage = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>
          Professional Tech Support Services in {countryData.name} |{" "}
          {siteConfig.name}
        </title>
        <meta
          name="description"
          content={`Leading tech support services across ${countryData.name}. Expert technicians providing computer repair, smart home setup, and IT support in all states. Nationwide coverage with local expertise.`}
        />
        <meta
          name="keywords"
          content={`tech support ${countryData.name}, computer repair nationwide, IT services ${countryData.name}, smart home setup`}
        />
      </Helmet>
      ...
      <div className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-rose-900 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-24">
          <div className="max-w-6xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/20 to-rose-500/20 backdrop-blur-md rounded-full px-8 py-3 mb-8 border border-purple-400/30 text-sm font-medium">
              <Flag className="w-6 h-6 text-rose-300" />
              Nationwide Coverage
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
              <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-3xl p-8 border border-purple-400/20 shadow-xl">
                <div className="text-4xl font-bold bg-gradient-to-r from-purple-300 to-rose-300 bg-clip-text text-transparent mb-3">
                  50+
                </div>
                <div className="text-lg text-gray-300">States Served</div>
              </div>
              <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-3xl p-8 border border-purple-400/20 shadow-xl">
                <div className="text-4xl font-bold bg-gradient-to-r from-rose-300 to-purple-300 bg-clip-text text-transparent mb-3">
                  24/7
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button
                size="lg"
                className="bg-gradient-to-r from-purple-600 to-rose-600 hover:from-purple-700 hover:to-rose-700 text-white font-semibold px-10 py-6 rounded-full shadow-2xl border border-purple-400/30 text-xl"
                onClick={() =>
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-purple-400/50 bg-white/5 backdrop-blur-md text-white hover:bg-purple-500/20 px-10 py-6 rounded-full font-semibold text-xl"
              >
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-purple-500/20 text-purple-700 rounded-full px-8 py-3 mb-6">
              <Target className="w-6 h-6" />
              <span className="font-medium text-lg">Why Choose Us</span>
            </div>
            <h2 className="text-5xl md:text-6xl font-bold mb-8 text-gray-900">
              Leading Tech Support in
              <span className="bg-gradient-to-r from-purple-700 via-purple-400 to-rose-400 bg-clip-text text-transparent ml-2">
                {countryData.name}
              </span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <Card className="group shadow-2xl hover:shadow-3xl transition-all duration-500 border-0 bg-gradient-to-br from-white/10 to-white/5 hover:-translate-y-3">
              <CardContent className="p-10 text-center">
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                  Professional tech support available in all 50 states across{" "}
                  {countryData.name}
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500/10 to-rose-500/10 text-purple-700 rounded-full px-8 py-3 mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
              {countryData.states.map((state, index) => (
                <Link
                  ...
                  className="group relative overflow-hidden rounded-2xl bg-white border border-purple-100 hover:border-purple-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 shadow-sm"
                >
                  <div className="p-8 text-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-purple-100 to-rose-100 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                      <Building className="w-8 h-8 text-purple-600" />
                    </div>
                    <h3 className="font-bold text-xl mb-3 text-gray-900 group-hover:text-purple-700 transition-colors">
                      {state.name}
                    </h3>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-100/10 to-rose-100/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  </div>
                </Link>
              ))}
            </div>
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="space-y-4 mb-8">
                      {category.services.slice(0, 3).map((service) => (
                        <div
                          key={service.id}
                          className="flex items-center gap-3 text-gray-700 p-3 rounded-lg hover:bg-gray-50 transition-colors"
                        >
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-3 font-semibold text-lg group-hover:gap-4 transition-all bg-gradient-to-r from-purple-600 to-rose-600 hover:from-purple-700 hover:to-rose-700 text-white px-6 py-3 rounded-full border border-purple-400/30 shadow"
                    >
                      View All Services
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {countrySpecialists.map((specialist, index) => (
              <Card
                key={index}
                className="shadow-xl text-center border border-purple-100 bg-white hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 rounded-2xl"
              >
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-700 mb-4">{specialist.experience}</p>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <h2 className="text-6xl md:text-8xl font-bold leading-tight mb-2 bg-gradient-to-r from-purple-700 via-purple-500 to-rose-600 bg-clip-text text-transparent">
              What {countryData.name} Says About Us
            </h2>
            <div className="text-4xl font-extrabold text-gray-900 mb-4">
              Testimonials
            </div>
            <p className="text-2xl text-gray-700">
              See what our customers across {countryData.name} have to say
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {countryTestimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="shadow-2xl border border-purple-100 bg-white hover:shadow-3xl transition-all duration-300 hover:-translate-y-2 rounded-2xl"
              >
                <CardContent className="p-10">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-purple-100 to-rose-100 rounded-full flex items-center justify-center">
      ...
      <section className="py-24 bg-gradient-to-br from-onassist-primary via-blue-600 to-purple-700 text-white relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-2xl md:text-3xl text-gray-900 font-semibold mb-12 leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              <div className="bg-gradient-to-r from-purple-500/10 to-rose-500/10 rounded-3xl p-8 w-full flex-1">
                ...
                <div className="text-lg text-purple-700">Response Time</div>
              </div>
              <div className="bg-gradient-to-r from-purple-500/10 to-rose-500/10 rounded-3xl p-8 w-full flex-1">
                <div className="text-4xl font-bold text-purple-700 mb-3">
                  5-Star
                </div>
                <div className="text-lg text-purple-700">Average Rating</div>
              </div>
              <div className="bg-gradient-to-r from-purple-500/10 to-rose-500/10 rounded-3xl p-8 w-full flex-1">
                <div className="text-4xl font-bold text-purple-700 mb-3">
                  Nationwide
                </div>
                <div className="text-lg text-purple-700">Coverage</div>
              </div>
              <div className="bg-gradient-to-r from-purple-500/10 to-rose-500/10 rounded-3xl p-8 w-full flex-1">
                <div className="text-4xl font-bold text-purple-700 mb-3">
                  Guaranteed
                </div>
                <div className="text-lg text-purple-700">Satisfaction</div>
              </div>
            </div>
